export default {
  ...
  gdevelopWindowsUrl:
    'https://github.com/4ian/GDevelop/releases/download/v5.0.0-beta67/gdevelop-setup-5.0.0-beta67.exe',
  gdevelopMacOSUrl:
    'https://github.com/4ian/GDevelop/releases/download/v5.0.0-beta67/gdevelop-5.0.0-beta67.dmg',
  gdevelopLinuxUrl:
    'https://github.com/4ian/GDevelop/releases/download/v5.0.0-beta67/gdevelop-5.0.0-beta67.tar.gz',
};
